...
export default function AgentPage() {
    ...
    const handleServiceChange = (e) => {
        ...
        fetch(`http://localhost:8080/api/services/localisations?service=${serviceNom}`)
            .then(res => res.json())
    ...
    return (
        <div className="max-w-4xl mx-auto p-4">
            <h1 className="text-2xl font-semibold text-[#b26148] mb-6">Accéder à la page Agent</h1>
            <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded shadow">
                ...
                >
                    ...
                    {localisations?.length > 0 ? (
                        ...
                        selectedService && (
                            <option disabled>Aucune localisation trouvée pour ce service</option>
                        )
                    )}
                </select>
