    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            <h1 className="text-3xl font-bold mb-6 text-[#b26148]"
                >Tableau de Bord de l'Administrateur</h1>
            <h2 className="text-xl font-semibold mb-4">Vue d'ensemble des Files d'Attente</h2>
                    ...
                    <tbody>
                        {queues.map((q, index) => (
                            <tr key={index}>
                                ...
                                <td className="px-4 py-2 border text-center">{q.clientsEnAttente}</td>
